...
Теги: model (ckpt), vae, lora, embed (emb), extension (ext), adetailer (ad), control (cnet), upscale (ups), clip, unet, vision, encoder (enc), diffusion (diff), config (cfg)Короткие-теги: начинаются с '$' без пробела -> $ckpt
------ Например ------
