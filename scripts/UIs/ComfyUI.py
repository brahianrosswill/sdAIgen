...
async def download_configuration():
    ...
    files = [
        ...
        f'{url_comfy}/comfy.settings.json, {WEBUI}/user/default',                         # ComfyUI settings
        f'{url_comfy}/Comfy-Manager/config.ini, {WEBUI}/user/default/ComfyUI-Manager',    # ComfyUI-Manager settings
        # workflows
